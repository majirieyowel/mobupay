defmodule Mobupay.Services.Termil do
  ...
  def send(:funds_transfer_onboarded, keywords) do
    message =
      "You received NGN3,000 from +2348108125280. Login at https://mobupay.com/+234823726626 to view your balance."
  ...
  def send(:funds_transfer_guest, keywords) do
    message =
      "You received NGN4,000 from +2348108125280. Visit https://mobupay.com/+234823726626 to claim."

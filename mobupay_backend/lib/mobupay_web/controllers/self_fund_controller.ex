defmodule MobupayWeb.SelfFundController do
  ...
  def index(%{assigns: %{current_user: user}} = conn, %{"funding_channel" => "Default"} = params) do
    Logger.info("Received request for self funding with params #{inspect(params)}")

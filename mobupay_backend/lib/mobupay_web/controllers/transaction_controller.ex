defmodule MobupayWeb.TransactionController do
         ...
         {:ok,
          %Transactions.Transaction{amount: transaction_amount, ref: reference} = transaction} <-
           Transactions.create_transaction(%{
             ...
             msisdn: msisdn,
             amount:
               Utility.format_paystack_amount(amount, CountryData.get_currency_unit(country)),
  ...
  def self_initiate(
    ...
    amount = Utility.format_paystack_amount(amount, CountryData.get_currency_unit(country))
